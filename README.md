...
| ExportInstanceIO | Extract | Writes the full I/O paths of an instance, or of every instance in an area and its sub-areas, to CSV: `-i LSC3_PumpVFDControl_CHWR.SetPointControl`, `-a LifeSci3` |
